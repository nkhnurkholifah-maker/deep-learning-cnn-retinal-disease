...
In conclusion, this project demonstrates the potential of deep learning based models as supportive tools for automated retinal disease screening. Future research may focus on larger datasets, improved class imbalance handling, and further validation to enhance clinical applicability.
</p>
...
## References
- Jameel & Abdulazeez, Ocular Disease Recognition Based on Deep Learning, IJCS, 2024.
- Kim et al., Fundus Image-Based Deep Learning Diagnostic Tool, J. Pers. Med., 2021.
- Virginia et al., Deep learning and convolutional neural networks (CNNs), GASJET, 2025.
